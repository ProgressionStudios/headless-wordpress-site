        ...
        <footer className={styles.footer}>
            ...
            <div className="container">
                <div className={styles.footerMain}>
                    <h2 className={styles.title}>Your Web Journey Starts Here</h2>
                    <h3 className={styles.description}>Let us aid in building and updating your website. Tell us about your next project.</h3>
            ...
            <div className={styles.copyright}>
                <div className="container">
                    ...
                    All Rights Reserved.
                    <span className={styles.divider}></span>
                    Developed by <Link href="/contact-us" className={styles.footerlink} >Progression Studios</Link>.
                </div>
            </div>
        </footer>
    );
